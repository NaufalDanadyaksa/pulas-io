...
export function CreateProjectModal({
  ...
  const onSubmit = async (data: CreateProjectInput) => {
    try {
      ...
      // Error handled by mutation or displayed via form
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle id="create-project-modal-title">Buat Project Baru</DialogTitle>
          <DialogDescription id="create-project-modal-description">
            Organisir whiteboard dan visual canvas Anda dalam satu wadah proyek.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pt-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Contoh: Architecture Design, Q3 Roadmap"
              aria-invalid={Boolean(errors.name)}
              aria-describedby={errors.name ? 'create-project-name-error' : undefined}
              {...register('name')}
            />
            {errors.name && (
              <p
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Deskripsi singkat tujuan atau ruang lingkup project..."
              ...
              aria-describedby={
                errors.description ? 'create-project-description-error' : undefined
              }
